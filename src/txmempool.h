...
public:
     ...
     *  be mined afterwards and would abort block assembly with "bad-protx-hash". (dash#7489) */
    ...
    */
     ...
     * stalling an honest producer. Policy may be stricter than consensus here, since a node that
     * rejects the second transaction still accepts a block containing it.
     */
