...
public:
    ...
    bool IsBlockValueValid(const CBlock& block, const int nBlockHeight, const CAmount blockReward, CAmount stakeValueIn, std::string& strErrorRet, const bool check_superblock);
