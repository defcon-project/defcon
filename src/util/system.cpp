...
const char * const BITCOIN_CONF_FILENAME = "defcon.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Defcon";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Defcon";
#else
    // Unix-like
    return pathRet / ".defcon";
#endif
#endif
}
