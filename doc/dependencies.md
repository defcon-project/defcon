...
These are the dependencies currently used by DeFCoN Core. You can find instructions for installing them in the `build-*.md` file for your platform.
...
| Qt | [5.15.19](https://download.qt.io/archive/qt/5.15/) | 5.15.0 | No | |  |
