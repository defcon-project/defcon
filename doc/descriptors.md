# Support for Output Descriptors in DeFCoN Core
...
existing DeFCoN Core wallets, a convenience function `combo` is
...
All RPCs in DeFCoN Core will include the checksum in their output. Only
