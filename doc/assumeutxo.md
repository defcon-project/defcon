...
Assumeutxo is a feature that allows fast bootstrapping of a validating defcond
...
considered active. This is the "traditional" mode of operation for defcond.
...
**Failure consideration:** if defcond unexpectedly halts after `m_stop_use` is set on
...
When defcond initializes again, what began as the snapshot chainstate is now
